...
const PersonalInfoForm = () => {
  ...
  return <Card className="glass-card bg-green-500">
      <CardHeader>
        <CardTitle className="flex items-center gap-2 text-card-foreground">
          <User className="w-5 h-5" />
          Personal Information
        </CardTitle>
        <CardDescription className="bg-green-500">
          ...
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              field
                    ...
                    <FormControl>
                      <Input placeholder="Enter your first name" className="bg-emerald-400" />
                    </FormControl>
                    <FormMessage />
                  </FormItem>} />
              ...
              field
                    ...
                    <FormControl>
                      <Input placeholder="Enter your last name" className="bg-emerald-400" />
                    </FormControl>
                    <FormMessage />
                  </FormItem>} />
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              field
                    ...
                    <FormControl>
                      <Input type="date" className="bg-emerald-400" />
                    </FormControl>
                    <FormMessage />
                  </FormItem>} />
            ...
            field
                  ...
                  <FormControl>
                    <Input placeholder="What do you do for work?" className="bg-emerald-400" />
                  </FormControl>
                  <FormMessage />
                </FormItem>} />
            ...
            <div className="space-y-4">
              ...
              field
                    ...
                    <FormControl>
                      <Textarea placeholder="Enter your full address" className="bg-emerald-400" />
                    </FormControl>
                    <FormMessage />
                  </FormItem>} />
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                field
                      ...
                      <FormControl>
                        <Input placeholder="City" className="bg-emerald-400" />
                      </FormControl>
                      <FormMessage />
                    </FormItem>} />
                ...
                field
                      ...
                      <FormControl>
                        <Input placeholder="State" className="bg-emerald-400" />
                      </FormControl>
                      <FormMessage />
                    </FormItem>} />
                ...
                field
                      ...
                      <FormControl>
                        <Input placeholder="PIN Code" className="bg-emerald-400" />
                      </FormControl>
                      <FormMessage />
                    </FormItem>} />
              </div>
            ...
            field
                  ...
                  <FormControl>
                    <Textarea placeholder="Tell us a little about yourself..." className="min-h-[100px] bg-emerald-400" />
                  </FormControl>
                  <FormMessage />
                </FormItem>} />

...
const SecuritySettings = () => {
  ...
  return <div className="space-y-6">
      ...
      {/* Password Management */}
      <Card className="glass-card bg-green-500">
        <CardHeader>
          <CardTitle className="flex items-center gap-2 text-card-foreground">
            ...
            <form onSubmit={passwordForm.handleSubmit(onPasswordSubmit)} className="space-y-4">
              ...
              field
                    ...
                    <FormControl>
                      <div className="relative bg-emerald-500">
                        <Input type={showCurrentPassword ? "text" : "password"} placeholder="Enter current password" className="bg-green-400" />
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                field
                      ...
                      <FormControl>
                        <div className="relative">
                          <Input type={showNewPassword ? "text" : "password"} placeholder="Enter new password" className="bg-emerald-500" />
                ...
                field
                      ...
                      <FormControl>
                        <div className="relative">
                          <Input type={showConfirmPassword ? "text" : "password"} placeholder="Confirm new password" className="bg-emerald-500" />
      ...
      {/* Active Sessions */}
      {securitySettings.deviceTracking && <Card className="glass-card bg-green-500">
          <CardHeader>
            <CardTitle className="flex items-center gap-2 text-card-foreground">
              <Smartphone className="w-5 h-5" />
              Active Sessions

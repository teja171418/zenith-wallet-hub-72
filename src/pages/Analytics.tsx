              ...
              <div className="p-6 bg-green-400">
                <div className="flex justify-between items-center mb-4">
                  ...
                  <div className="flex gap-2">
                    ...
                    <Button variant={chartType === 'bar' ? 'default' : 'outline'} size="sm" onClick={() => setChartType('bar')} className="bg-blue-600 hover:bg-blue-500">
            ...
            <Card className="glass-card">
              <div className="p-6 bg-green-500">
                ...
                <div className="space-y-4">
                  {currentTrends.map((trend, index) => <div key={index} className="flex items-center justify-between p-4 rounded-lg border bg-blue-500">
